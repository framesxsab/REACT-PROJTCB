    ...
    <div className="font-serif text-gray-100 min-h-screen bg-cover bg-fixed bg-no-repeat relative"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex flex-col md:flex-row justify-between items-center max-w-4xl mx-auto">
            <ul className="flex space-x-8 mb-4 md:mb-0 text-lg font-semibold">
              <li><Link to="/" className="bg-gradient-to-r from-cyan-500 via-blue-500 to-blue-700 text-white px-5 py-2 rounded-xl hover:from-cyan-400 hover:to-blue-800 transition-all duration-200 hover:scale-105 hover:shadow-lg flex items-center gap-1 shadow-md">Home</Link></li>
              <li><Link to="/explore" className="bg-gradient-to-r from-cyan-500 via-blue-500 to-blue-700 text-white px-5 py-2 rounded-xl hover:from-cyan-400 hover:to-blue-800 transition-all duration-200 hover:scale-105 hover:shadow-lg flex items-center gap-1 shadow-md">Resources</Link></li>
              <li><Link to="/about" className="bg-gradient-to-r from-cyan-500 via-blue-500 to-blue-700 text-white px-5 py-2 rounded-xl hover:from-cyan-400 hover:to-blue-800 transition-all duration-200 hover:scale-105 hover:shadow-lg flex items-center gap-1 shadow-md">About</Link></li>
            </ul>
            <Link to="/contribute"
      ...
      <main className="relative z-10 py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="glass-container rounded-lg p-8 mb-8 bg-gradient-to-br from-cyan-900/60 via-blue-800/40 to-blue-600/30 backdrop-blur-md border border-cyan-400/30 shadow-2xl">
          <h2 className="text-3xl font-bold mb-6 text-cyan-300 text-center font-[Cinzel] drop-shadow-lg">Meet Our Team</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div className="team-member text-center bg-cyan-900/30 backdrop-blur-md border border-cyan-400/30 rounded-2xl p-8 shadow-xl hover:shadow-cyan-400/40 transition-all duration-300 group">
              <div className="flex justify-center mb-4">
                <img src="/dekisuki.jpg" alt="Ramesssss" className="rounded-full w-44 h-44 object-cover border-4 border-cyan-300 shadow-lg group-hover:scale-105 group-hover:border-cyan-400 transition-transform duration-300" />
              </div>
              <h3 className="text-2xl font-bold text-cyan-100 font-[Cinzel]">Ramesssss</h3>
              <p className="text-cyan-200 mt-2 font-semibold">Founder & Developer</p>
              <p className="text-base text-cyan-100/80 mt-4">Leads technical development and platform architecture.</p>
            </div>
            <div className="team-member text-center bg-cyan-900/30 backdrop-blur-md border border-cyan-400/30 rounded-2xl p-8 shadow-xl hover:shadow-cyan-400/40 transition-all duration-300 group">
              <div className="flex justify-center mb-4">
                <img src="/nobita.png" alt="Suresssss" className="rounded-full w-44 h-44 object-cover border-4 border-cyan-300 shadow-lg group-hover:scale-105 group-hover:border-cyan-400 transition-transform duration-300" />
              </div>
              <h3 className="text-2xl font-bold text-cyan-100 font-[Cinzel]">Suresssss</h3>
              <p className="text-cyan-200 mt-2 font-semibold">Content Manager</p>
              <p className="text-base text-cyan-100/80 mt-4">Curates high-quality educational resources.</p>
            </div>
          </div>
        </section>
...
//   return (
//     <div
//       className="font-serif text-white min-h-screen bg-cover bg-fixed bg-no-repeat relative"
//       style={{ backgroundImage: "url('/images/background1.jpg')" }}
//     >
...
//           <h1 className="text-5xl font-bold font-[Cinzel] text-blue-200 drop-shadow-lg">About Us</h1>
//         </div>
//       </header>

//       {/* Nav */}
//       <nav className="relative z-10 max-w-4xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center mb-8">
//         <ul className="flex gap-6 mb-4 sm:mb-0 text-lg">
//           <li><Link to="/" className="hover:text-blue-300 transition">Home</Link></li>
//           <li><Link to="/explore" className="hover:text-blue-300 transition">Resources</Link></li>
//           <li><Link to="/about" className="hover:text-blue-300 transition">About</Link></li>
//         </ul>
//         <Link
//           to="/contribute"
//           className="bg-blue-600 text-white px-5 py-2 rounded-md hover:bg-blue-700 transition transform hover:scale-105 shadow-md"
//         >
//           Contribute
//         </Link>
//       </nav>
...
//         {/* Mission */}
//         <section className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-xl mb-12">
//           <h2 className="text-3xl font-bold text-blue-300 mb-4">Our Mission</h2>
//           <p className="text-lg text-gray-200">
//             We aim to empower students by providing curated resources to support their academic goals. From study guides to cozy study spots, we help you discover tools that make learning easier and more enjoyable.
//           </p>
//         </section>

//         {/* Team */}
//         <section className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-xl mb-12">
//           <h2 className="text-3xl font-bold text-blue-300 text-center mb-8">Meet the Team</h2>
//           <div className="grid md:grid-cols-2 gap-10">
//             {/* Member 1 */}
//             <div className="text-center p-6 rounded-xl bg-gray-900/50 border border-blue-500/20 hover:border-blue-500 transition">
//               <img
//                 src="/images/dekisuki.jpg"
//                 alt="Ramesssss"
//                 className="w-36 h-36 mx-auto rounded-full object-cover border-4 border-blue-500 shadow-lg mb-4"
//               />
//               <h3 className="text-xl font-semibold">Ramesssss</h3>
//               <p className="text-gray-300">Founder & Developer</p>
//               <p className="text-sm text-gray-400 mt-2">
//                 Leads all things code and design.
//               </p>
//             </div>
...
//             <div className="text-center p-6 rounded-xl bg-gray-900/50 border border-blue-500/20 hover:border-blue-500 transition">
//               <img
//                 src="/images/nobita.png"
//                 alt="Suresssss"
//                 className="w-36 h-36 mx-auto rounded-full object-cover border-4 border-blue-500 shadow-lg mb-4"
//               />
//               <h3 className="text-xl font-semibold">Suresssss</h3>
...
//         {/* Contact */}
//         <section className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-xl">
//           <h2 className="text-3xl font-bold text-blue-300 mb-6">Contact Us</h2>
//           <form
//             onSubmit={(e) => {
//               e.preventDefault();
//               alert("Thanks for your message! (EmailJS not yet integrated.)");
//             }}
//             className="space-y-6"
//           >
//             <div>
...
//                 rows="4"
//                 required
//                 className="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
//               />
//             </div>

//             <button
//               type="submit"
//               className="w-full bg-blue-600 text-white py-3 px-6 rounded-md hover:bg-blue-700 transition transform hover:scale-105 shadow-lg"
//             >
//               Send Message
//             </button>
//           </form>
...
//       {/* Footer */}
//       <footer className="relative z-10 text-center text-gray-400 py-8 border-t border-white/20">
//         <p>&copy; 2025 Student Resources. All rights reserved.</p>
//         <p>
//           Email:{" "}
//           <a href="mailto:info@studentresources.com" className="text-blue-300 hover:underline">
