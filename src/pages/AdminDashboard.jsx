        ...
        {resources.length === 0 ? (
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {resources.map((resource, index) => (
              <div
                key={index}
                className="relative bg-white/20 backdrop-blur-2xl p-8 rounded-3xl shadow-2xl hover:shadow-cyan-400/40 transition-all duration-300 group border border-cyan-400/20 animate-fadein"
